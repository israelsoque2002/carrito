...
// Variable to store number of products in the cart
$numProductos = 0;
...
<head>
    ...
    <style>
        ...
        .producto-container {
            ...
            margin-bottom: 20px;
            /* Margen inferior del contenedor */
            text-align: center;
        ...
        .cantidad-form input[type="number"] {
            ...
            /* Borde para el campo de cantidad */
            padding: 5px;
            /* Espacio interno del campo de cantidad */
        }
...
<body>
    ...
    <div class="container">
        <div class="row">
            <?php
            // Check if there are products fetched from the database
                            ...
                            <div class="card-body">
                                ...
                                <div class="producto-container">
                                    <form action="carrito.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <button class="btn btn-primary btn-form" name="btnAccion" value="Agregar" type="submit">Agregar al carrito</button>
                                    </form>
                                </div>
                            </div>
                        </div>
